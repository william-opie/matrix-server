...
- This stack is configured for tailnet-only media candidates. If calls fail on mobile data, verify the client is connected to Tailscale and `LIVEKIT_NODE_IP` is set to the host's Tailscale IPv4.
